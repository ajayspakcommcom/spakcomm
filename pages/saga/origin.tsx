            ...
            <Wrapper>
                ...
                <Container className='home-before-footer'>
                    <Row>
                        <Col lg={8}>
                            <strong>
                                Ingenious Artists. Artistic Visionaries. Masterful Designers. Collaborative Thinkers. Skillful Creators. Insightful Inventors. Thoughtful Illustrators. Artistic Masters. Innovative Draftsmen. Visionary Planners.
                            </strong>
                        </Col>
                    </Row>
                </Container>
