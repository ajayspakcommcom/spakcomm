...
const Index: React.FC = () => {
    return (
        <>
            <SEO pageTitle={'Echoes'} description={'Description'} keywords={'Keywords'} author={'Author'} />
            <Header />
            <Wrapper>
                <OtherHeader img='origin.png' heading='Echoes' paragraph='The heart & purpose of Spakcomm' />
                <Container>
